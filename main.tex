...
% Info
\title{A Utilização de Banco de Dados Geográficos pela Geografia Brasileira. Um Estudo sobre o Estado da Arte e a Aplicação de Tecnologias Integradas a um Estudo de Caso na Bacia Hidrográfica do Rio São João - RJ}
...
\begin{document}
	...
	\begin{titlepage}
		...
		\begin{center}
			...
			[7.2cm]
		\end{center}
		\Large{A Utilização de Banco de Dados Geográficos pela Geografia Brasileira. Um Estudo sobre o Estado da Arte e a Aplicação de Tecnologias Integradas a um Estudo de Caso na Bacia Hidrográfica do Rio São João - RJ} \\
		[6cm] \\
		% \line(1,0){400} \\
		\begin{flushright}
...
%		[1cm]
%	\begin{center}
%		\textsc{\large A Utilização de Banco de Dados Geográficos pela Geografia Brasileira. Um Estudo sobre o Estado da Arte e a Aplicação de Tecnologias Integradas à um Estudo de Caso na Bacia Hidrográfica do Rio São João - RJ} \\
%			[3cm]
%	\end{center} 
%		\setlength{\leftskip}{6cm}
%			Dissertação de Mestrado apresentada ao Programa de Pós-Graduação em Geografia, Universidade Federal do Rio de Janeiro, como requisito parcial à obtenção do título de Mestre em Geografia. \\ [3cm]
%	\begin{center}
%		\line(1,0){350} \\
%		{\normalsize Orientador, Rafael Silva de Barros, Dr., UFRJ} \\
%		[0.7cm] 
%		\line(1,0){350} \\
%		{\normalsize Coorientadora, Carla Bernadete Madureira Cruz, Dra., UFRJ} \\
%		[0.7cm] 
%		\line(1,0){350} \\
%		{\normalsize Vinicius da Silva Seabra, Dr., UERJ/FFP} \\
%		[0.7cm] 
%		\line(1,0){350} \\
%		{\normalsize Paula Maria Moura de Almeida, Dra., UCB/UFRJ} \\
%		[2cm] 
%		Rio de Janeiro \\
%		Janeiro de 2017
%	\end{center}
	...
	\input{pesq_operacional}
	
	\part{Metodologia}
	\input{materiais_e_metodos}
